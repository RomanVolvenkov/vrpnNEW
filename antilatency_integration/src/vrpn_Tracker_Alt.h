...
{
public:
    vrpn_Tracker_Alt(const char* name, vrpn_Connection* trackercon, std::string placementCode = "", std::string environmentCode = "", bool zv = false, bool zav = false);
	~vrpn_Tracker_Alt(){
...
protected:
    ...
    static Antilatency::Alt::Environment::Selector::ILibrary _envSelectorLibrary;
